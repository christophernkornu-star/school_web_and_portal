...
export const ClassFeeReport = React.forwardRef<HTMLDivElement, ClassFeeReportProps>(({ className, students, feeStructures, payments }, ref) => {
  ...
  return (
    <div ref={ref} className="p-4 md:p-8 bg-white text-black print:p-8 max-w-4xl mx-auto">
      {/* Header */}
      <div className="text-center mb-6 md:mb-8 border-b-2 border-gray-800 pb-4 md:pb-6">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-2 md:gap-8 mt-4 text-sm font-medium text-gray-600">
