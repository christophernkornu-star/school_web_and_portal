// Create an executable test of fetchReportCardData bypassing TS imports.
...
async function test() {
  ...
  const targetTermId = '323db830-2bb5-4580-a16e-884ae115a3bc';
  ...
  if (remarkForTerm) {
      console.log('classTeacher:', remarkForTerm.class_teacher_remark);
  } else {
      console.log('remarkForTerm not found for term', targetTermId);
  }
}
test();
