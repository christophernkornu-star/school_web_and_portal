...
import { ArrowLeft, Save, Users, TrendingUp, AlertCircle } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">No Class Teacher Assignment</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Record Attendance</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <h3 className="font-semibold text-green-900 mb-4 text-sm md:text-base">⚡ Quick Fill All Students</h3>
            <div className="flex items-end space-x-3">
              <div className="flex-1">
                <label className="block text-xs md:text-sm font-medium text-green-800 mb-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-green-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                />
              </div>
              <button
                onClick={applyToAll}
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h3 className="text-base md:text-lg font-semibold text-gray-800 mb-4">Select Class</h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ghana-green focus:border-transparent text-sm"
              >
            ...
            <div>
              ...
              <div className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 font-medium text-sm">
        ...
        {selectedClass && students.length > 0 && (
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-base md:text-lg font-semibold text-gray-800 mb-4">Filter & Sort Options</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs md:text-sm font-medium text-gray-700 mb-2">
                  Show Students
        ...
        {selectedClass && students.length > 0 && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6">
            <div className="bg-white rounded-lg shadow p-4 md:p-6">
              ...
              <p className="text-xl md:text-3xl font-bold text-gray-800">{stats.totalStudents}</p>
            ...
            <div className="bg-green-50 rounded-lg shadow p-4 md:p-6 border border-green-200">
              <div className="flex items-center justify-between mb-2">
                <p className="text-green-700 text-xs md:text-sm font-medium">Overall Rate</p>
                <TrendingUp className="w-4 h-4 md:w-5 md:h-5 text-green-600" />
              </div>
              <p className="text-xl md:text-3xl font-bold text-green-800">{stats.overallRate}%</p>
              <p className="text-[10px] md:text-sm text-green-600 mt-1">
            ...
            <div className="bg-blue-50 rounded-lg shadow p-4 md:p-6 border border-blue-200">
              <div className="flex items-center justify-between mb-2">
                <p className="text-blue-700 text-xs md:text-sm font-medium">Boys Rate</p>
                <Users className="w-4 h-4 md:w-5 md:h-5 text-blue-600" />
              </div>
              <p className="text-xl md:text-3xl font-bold text-blue-800">{stats.boysRate}%</p>
              <p className="text-[10px] md:text-sm text-blue-600 mt-1">
                {stats.boys} male students
              </p>
            </div>

            <div className="bg-pink-50 rounded-lg shadow p-4 md:p-6 border border-pink-200">
              <div className="flex items-center justify-between mb-2">
                <p className="text-pink-700 text-xs md:text-sm font-medium">Girls Rate</p>
                <Users className="w-4 h-4 md:w-5 md:h-5 text-pink-600" />
              </div>
              <p className="text-xl md:text-3xl font-bold text-pink-800">{stats.girlsRate}%</p>
              <p className="text-[10px] md:text-sm text-pink-600 mt-1">
                  ...
                  {getFilteredAndSortedStudents().map((student, index) => {
                    ...
                    return (
                      <tr key={student.id} className={`hover:bg-gray-50 ${
                        student.gender?.toLowerCase() === 'male' ? 'bg-blue-50/30' : 'bg-pink-50/30'
                      }`}>
                        <td className="px-6 py-4 text-xs md:text-sm font-bold text-gray-500">
                          {index + 1}
                        </td>
                        <td className="px-6 py-4 text-xs md:text-sm font-medium text-gray-900">
                          {student.student_id}
                        </td>
                        <td className="px-6 py-4 text-xs md:text-sm text-gray-900">
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="flex items-center justify-center space-x-2">
                            <input
                              ...
                              autoFocus={index === 0}
                              className="w-16 md:w-20 px-2 md:px-3 py-1 md:py-2 border-2 border-gray-300 rounded-lg text-center text-sm md:text-lg font-semibold focus:ring-2 focus:ring-ghana-green focus:border-ghana-green transition"
                            />
                            <span className="text-gray-500 text-xs md:text-sm font-medium">/ {totalDays}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 text-center">
                          <span className={`px-3 py-1 rounded-full text-xs md:text-sm font-semibold ${
                            ...
                            parseFloat(percentage) >= 75 ? 'bg-blue-100 text-blue-800' :
        ...
        {selectedClass && students.length === 0 && (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-2">No Students Found</h3>
            <p className="text-gray-600">
        ...
        {!selectedClass && (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            <AlertCircle className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-2">Select a Class</h3>
            <p className="text-gray-600">
