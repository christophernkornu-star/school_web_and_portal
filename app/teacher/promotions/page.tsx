        ...
        <header className="bg-white shadow">
          <div className="container mx-auto px-4 md:px-6 py-4">
            <div className="flex items-center space-x-4">
              <Link href="/teacher/dashboard" className="p-2 hover:bg-gray-100 rounded-lg transition">
                <ArrowLeft className="w-5 h-5 md:w-6 md:h-6 text-gray-600" />
              </Link>
              <div>
                <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900">Student Promotions</h1>
                <p className="text-xs md:text-sm text-gray-600">Manage end-of-year promotions</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="container mx-auto px-4 md:px-6 py-8">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 md:p-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-900 mb-2 text-sm md:text-base">No Classes Assigned</h3>
                <p className="text-blue-800 text-xs md:text-sm">
                  You are not assigned as a <strong>class teacher</strong> for any class.
                </p>
                <p className="text-xs md:text-sm text-blue-700 mt-3">
        ...
        <div className="container mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900">Student Promotion Decisions</h1>
                <p className="text-xs md:text-sm text-gray-600">Academic Year: {academicYear} - Students Below 30% Average</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 md:px-6 py-8">
        {submitSuccess && (
          <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4 flex items-start space-x-3">
            ...
            <div>
              <p className="text-green-800 font-medium text-sm md:text-base">Promotion decisions submitted successfully!</p>
        ...
        <div className="bg-white rounded-lg shadow p-4 md:p-6 mb-6">
          <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-4">Select Class</h2>
          <div className="max-w-md">
            <select
              value={selectedClass}
              onChange={(e) => setSelectedClass(e.target.value)}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ghana-green focus:border-transparent text-xs md:text-sm"
            >
        ...
        {selectedClass && (
          <>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 md:p-6 mb-6">
              <h3 className="font-semibold text-blue-900 mb-3 flex items-center space-x-2 text-sm md:text-base">
                <FileText className="w-4 h-4 md:w-5 md:h-5" />
                <span>Students Requiring Your Decision</span>
              </h3>
              <div className="text-blue-800 space-y-2 text-xs md:text-sm">
                <p>
            ...
            {recommendations.length > 0 && (
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white rounded-lg shadow p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl md:text-2xl font-bold text-gray-900">{recommendations.length}</p>
                    </div>
                ...
                <div className="bg-green-50 rounded-lg shadow p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs md:text-sm text-green-700">To Promote</p>
                      <p className="text-xl md:text-2xl font-bold text-green-900">{promoteCount}</p>
                    </div>
                    <TrendingUp className="w-8 h-8 md:w-10 md:h-10 text-green-500" />
                  </div>
                </div>

                <div className="bg-red-50 rounded-lg shadow p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs md:text-sm text-red-700">To Repeat</p>
                      <p className="text-xl md:text-2xl font-bold text-red-900">{repeatCount}</p>
                    </div>
            ...
            {loadingRecommendations ? (
              <div className="bg-white rounded-lg shadow p-12 text-center">
                ...
                <p className="text-xs md:text-sm text-gray-600">Loading student recommendations...</p>
              </div>
            ) : recommendations.length === 0 ? (
              <div className="bg-white rounded-lg shadow p-12 text-center">
                <CheckCircle className="w-12 h-12 md:w-16 md:h-16 text-green-500 mx-auto mb-4" />
                <h3 className="text-base md:text-lg font-semibold text-gray-800 mb-2">All Students Auto-Promoted!</h3>
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {recommendations.map((rec) => {
                        const decision = decisions.get(rec.student_id)
                        return (
                          <tr key={rec.student_id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 md:px-6 py-4">
                              <input
                                ...
                                className="w-full px-3 py-1 border border-gray-300 rounded-lg text-xs md:text-sm focus:ring-2 focus:ring-ghana-green focus:border-transparent"
                              />
                            </td>
                          </tr>
                        )
                ...
                {/* Submit Button */}
                <div className="bg-gray-50 px-4 md:px-6 py-4 flex justify-end space-x-4">
                  <Link
                    href="/teacher/dashboard"
                    className="px-4 md:px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition text-xs md:text-sm"
                  >
                    Cancel
                  </Link>
                  <button
