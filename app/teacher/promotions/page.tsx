  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <main className="container mx-auto px-4 md:px-6 py-8">
        ...
        {error && (
          <div className="mb-6 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800/60 rounded-2xl shadow-sm p-4 flex items-start space-x-3">
            <XCircle className="w-4 h-4 md:w-5 md:h-5 text-rose-600 dark:text-rose-400 flex-shrink-0 mt-0.5" />
            <p className="text-rose-800 dark:text-rose-300 text-sm md:text-base">{error}</p>
          </div>
        )}
        ...
        <div className="bg-white dark:bg-gray-800/90 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-4 md:p-6 mb-6 backdrop-blur-sm">
          <h2 className="text-lg md:text-xl font-bold tracking-tight text-gray-900 dark:text-white mb-4">Select Class</h2>
        ...
        {selectedClass && (
          <>
            {/* Info Card */}
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/60 rounded-2xl shadow-sm p-4 md:p-6 mb-6">
            ...
            {recommendations.length > 0 && (
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white dark:bg-gray-800/90 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-5 md:p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl md:text-3xl font-black tracking-tight text-gray-900 dark:text-white mt-1">{recommendations.length}</p>
                    </div>
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl shadow-sm border border-emerald-100 dark:border-emerald-800/50 p-5 md:p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs md:text-sm text-emerald-700 dark:text-emerald-300">To Promote</p>
                      <p className="text-xl md:text-2xl font-bold text-green-900 dark:text-emerald-400">{promoteCount}</p>
                    </div>
                    <TrendingUp className="w-8 h-8 md:w-10 md:h-10 text-emerald-500 dark:text-emerald-400" />
                  </div>
                </div>
                ...
                <div className="bg-rose-50 dark:bg-rose-900/20 rounded-2xl shadow-sm border border-rose-100 dark:border-rose-800/50 p-5 md:p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs md:text-sm text-rose-700 dark:text-rose-300">To Repeat</p>
                      <p className="text-xl md:text-2xl font-bold text-red-900 dark:text-rose-400">{repeatCount}</p>
                    </div>
                    <TrendingDown className="w-8 h-8 md:w-10 md:h-10 text-rose-500 dark:text-rose-400" />
                  </div>
                </div>
              </div>
            )}
                        ...
                        {recommendations.map((rec) => {
                          ...
                          return (
                            <tr key={rec.student_id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                              ...
                              <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                                {rec.meets_criteria ? (
                                  <span className="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300">
                                    Meets Criteria
                                  </span>
                                ) : (
                                  <span className="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300">
                                    Below Threshold
                                  </span>
                                )}
                              </td>
                    ...
                    return (
                      <div key={rec.student_id} className="bg-white dark:bg-gray-800/90 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-5 space-y-3">
                        <div className="flex justify-between items-start">
                          ...
                          {rec.meets_criteria ? (
                             <span className="px-2 py-0.5 inline-flex text-[10px] font-semibold rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300">
                               Criteria Met
                             </span>
                           ) : (
                             <span className="px-2 py-0.5 inline-flex text-[10px] font-semibold rounded-full bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300">
                               Below
                             </span>
                           )}
                        </div>
